...
class TestFetch(unittest.TestCase):
    ...
    def test_createDefaultFilepath_givenPostSeasonWeek1(self):
        ...
        actual = fetch._create_default_filepath(self.schedule, 'ffpicker-raw-data/schedules')
    ...
    def test_createDefaultFilepath_givenPreSeasonWeek1(self):
        ...
        actual = fetch._create_default_filepath(self.schedule, 'ffpicker-data/schedules')
        self.assertEqual(actual, expected)
    ...
    def test_createScheduleUrl_givenPostSeasonWeek1_returnsUrlWithWeek18(self):
        ...
        actual = fetch._create_schedule_url(self.schedule)
        self.assertEqual(actual, expected)
